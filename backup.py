...
if fl is not None:
    ...
    if file_extension != 'csv':
        st.error("The uploaded file does not contain the required columns: 'sentiment' and 'Date'")
    else:
        df = pd.read_csv(fl)
        # selecting date and time

        # Row A (Displaying the total no.of reviews, positive and negative reviews in first row)
        # Calculate metrics
        ...
        # Row B (Displaying the start and end date of the dataset)
